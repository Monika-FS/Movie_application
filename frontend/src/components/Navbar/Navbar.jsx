      ...
      <nav className="fixed top-0 z-50 w-full bg-white shadow">
        ...
        >
          ...
          <div className="flex-grow hidden px-2 py-2 md:flex ">
            <div className="p-1 ">
              <IoIosSearch className="w-10 h-6 text-rose-900 " />
            </div>
            <input
              type="text"
              className="flex-grow px-2 py-1 border border-orange-900 rounded-md outline-none"
          ...
          {/* <Link to="/signin" className="hidden md:block">
            <button className="px-3 py-1 text-white rounded-md  bg-rose-700 hover:cursor-pointer whitespace-nowrap">
              Sign in{" "}
            </button>
          </Link> */}
